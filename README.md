...
* **Run:** Envia o Payload para o AnythingLLM -> realiza o embedding das questions pela API do OLLam e realiza um comparação em similarity threshold com embeddings vetorizados dos chunks do documento de contextualização pré vetorizado no AnythingLLM -> armazena os chunks recuperados.
